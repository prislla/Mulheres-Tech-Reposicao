...
<?php
   ...
   $qnt_pagina = ceil($resposta['registros'] / $limitereg);
    ...
    echo "<a href='mochilas.php?page=1'>Primeira</a> ";
  ...
  for ($anterior = $pag - $maximo; $anterior <= $pag - 1; $anterior++) {
      if ($anterior >= 1) {
          echo "  <a href='mochilas.php?page=$anterior'>$anterior</a> ";
      }
  }
  ...
  for ($proxima = $pag + 1; $proxima <= $pag + $maximo; $proxima++) {
      if ($proxima <= $qnt_pagina) {
          echo "<a href='mochilas.php?page=$proxima'>$proxima</a> ";
      }
  }

  echo "<a href='mochilas.php?page=$qnt_pagina'>Última</a> ";
