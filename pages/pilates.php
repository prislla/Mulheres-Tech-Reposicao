...
<div class="container-fluid texto">
    <div class="row">
      ...
      <h1>Modalidades do Jump</h1>
        <img src="../img/jumpcapa.jpg"class="img-fluid">
      </div>
    </div>
  </div>
  ...
  <div class="container-fluid text-center conteudo">
    <div class="row">
      <div class="col-md-6 col-sm">
        <img src="../img/jump1.jpg" class="img-fluid">
      </div>
      <div class="col-md-6 col-sm">
        <h3>Body Jump</h3>
        <p>Proporciona condicionamento físico, alto gasto calórico e melhora da postura utilizando o mini-trampolim. As músicas são explosivas e as coreografias simples e com uma ótima didática, permitindo você chegar ao melhor do seu potencial.</p>
        <p>60 minutos de muita diversão num treinamento coletivo, aumento da força muscular dos membros inferiores (músculos das pernas), aumento e melhora da contração de estabilizadores (abdominal e lombar), gasto calórico de até 700 K/cal, melhora da condição cardio vascular, melhora das habilidades motoras, aumento da concentração;
aumento do equilíbrio corporal, devido ser uma modalidade também com objetivo proprioceptivo, etc.</p>
      </div>
    </div>
  </div>
